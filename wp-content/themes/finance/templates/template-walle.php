  ...
  <section id="breadcrumbs" class="breadcrumbs">
    ...
    <section id="news" class="news">
        <div class="container" data-aos="zoom-in">
            <header class="section-header">
              <h3>Hướng dẫn đăng ký Ví Điện Tử</h3>
            </header>
            <div class="row">
	                ...
	                <div class="box box-normal box-text-bottom box-blog-post has-hover">
					   <div class="box-image">
					      <div class="image-cover" style="padding-top:65%"> 
					      	<img src="<?php echo get_template_directory_uri();?>/assets/img/news/momo.jpg" class="attachment-medium size-medium wp-post-image"> 
					      </div>
					   </div>
					   <div class="box-text text-left">
					      <div class="box-text-inner blog-post-inner">
					         <h5 class="post-title is-large">Hướng Dẫn Đăng Ký MoMo</h5>				         
					         <p class="from_the_blog_excerpt">Nhận 500k quà tặng&nbsp;khi đăng ký mới ví điện tử MoMo</p>
					      </div>
					   </div>
					</div>
			    </a>
