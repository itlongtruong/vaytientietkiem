 ...
 */
$args = array(
	'post_type'        => 'vay-tien-nhanh',		
	'numberposts'      => $pagename == 'vay-tien-nhanh' ? -1 : 6,
	'orderby'          => 'date',
	'order'            => 'ASC',		
);
$data = get_posts( $args );
    ...
    <section id="pricing" class="pricing section-bg wow fadeInUp">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3><?php echo $pagename == 'vay-tien-nhanh' ?  'So sánh khoản vay online từ các đối tác uy tín tại VayTienOnline' : 'Các sản phẩm vay online'?></h3>          
        </header>
		...
		<?php
			...
			foreach ($data as $post) {
				...
				$so_tien_vay = get_field_object('so_tien_vay' , $post_id);
				$lai_suat = get_field_object('lai_suat' , $post_id);
				$do_tuoi_vay = get_field_object('do_tuoi_vay' , $post_id);
				$thoi_gian_vay = get_field_object('thoi_gian_vay' , $post_id);
          ...
          <div class="col-xs-12 col-lg-4 product-2" data-aos="fade-up" data-aos-delay="<?php echo $delay*100; ?>">
            <div class="card">
              ...
              <div class="card-block">
                <h3>
				<?php echo $so_tien_vay['value'];?><span class="currency">triệu</span><span class="period">lãi suất</span>
                <?php echo $lai_suat['value'];?><span class="currency">%</span><span class="period">/năm</span>
                </h3>
                <ul class="list-group">
                  <li class="list-group-item"><?php echo $do_tuoi_vay['value'];?></li>
                  <li class="list-group-item"><?php echo $thoi_gian_vay['value'];?></li>
